  ...
  return (
    ...
    <section id="about" className="relative overflow-hidden text-gray-600 body-font flex flex-col" data-aos="fade-up" data-aos-delay="400">
        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
            ...
            <img src={img_about} className='object-cover md:w-[300px] md:h-[450px] object-center rounded relative z-10 rotate-3' alt={t('about.img_aboutAlt')}/>            
            </div>
        <div data-aos="fade-left" data-aos-delay="400" className="lg:flex-grow md:w-1/2 lg:pl-8 md:pl-8 flex flex-col md:items-start md:text-start items-center text-center">
